/*
 * Copyright (C) 12.10.2006 | Naoghuman (Peter Rogge) | peter.rogge@yahoo.de
 *
 ...
 * 
 * @author Naoghuman (Peter Rogge) | Copyright (c) | 12.10.2006
 * @version 1.1
 * @change 19.02.2007
 * @change 30.04.2007
 */
public class ArrayListLight<E> extends AbstractList<E> implements List<E>,
		RandomAccess {
	...
	public ArrayListLight(final int initialCapacity) {
    ...
    /**
     * Increases the capacity of this <code>ArrayListLight</code> instance, if
    ...
    /**
	 * Liefert die Kapazität des <code>ArrayListLight</code>. Dies entspricht
	 * nicht der Anzahl der enthaltenen Elemente, sondern wieviele Elemente
	 * in das <code>ArrayListLight</code> gespeichert werden kann.
	 * 
	 * @return Kapazität des <code>ArrayListLight</code>.
	 */
	public int getLength() { return elementData.length; }
	 ...
	 * list. If the object is found in this list, each component in the
	 * list with an index greater or equal to the object's index is shifted
	...
	public final boolean remove(final Object obj) {
		...
		if (i >= 0) { this.remove(i); return Boolean.TRUE; }
     ...
     *		  <code>(index &lt; 0 || index &gt;= size())</code>.
     */
	public final E replace(final int index, final E element) {
	...
	public final E set(final int index, final E element) {
		...
		return this.replace(index, element);
    }
	
	/**
	 * Returns the current size of <code>ArrayListLight</code>. Deprecated. Use
    ...
    /**
	 * Trims the capacity of this <code>ArrayListLight</code> instance to be the
	 * list's current size. An application can use this operation to minimize
	 * the storage of an <code>ArrayListLight</code> instance.
	 */
    @SuppressWarnings("unchecked")
