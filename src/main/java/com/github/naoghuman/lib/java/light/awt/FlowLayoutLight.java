/*
 * Copyright (C) 09.10.2006 | Naoghuman (Peter Rogge) | peter.rogge@yahoo.de
 *
...
/**
 * A <code>FlowLayoutLight</code> arranges components in a directional flow,
 * much like lines of text in a paragraph. The flow direction is
 ...
 * </ul>
 * <code>FlowLayoutLight</code> are typically used to arrange buttons in a
 * panel. It arranges buttons horizontally until no more buttons fit on
 * the same line. The line alignment is determined by the <code>align</code>
 ...
 * <p>
 * 
 * @author Naoghuman (Peter Rogge) | Copyright (c) | 09.10.2006
 * @version 1.0
 */
public class FlowLayoutLight implements LayoutManager, java.io.Serializable {
	...
	/**
	 * This is the left border (in pixels) which specifies the space
	 * on the left side form the parent component. This should be a
	 * non-negative short.
	 */
	private short left = 0;
	
	/**
	 * This is the right border (in pixels) which specifies the space
	 * on the right side form the parent component. This should be a
	 * non-negative short.
	 */
	private short right = 0;
	
	/**
	 * This is the top border (in pixels) which specifies the space
	 * on the top side form the parent component. This should be a
	 * non-negative short.
	 */
	private short top = 0;
	
	/**
	 * This is the bottom border (in pixels) which specifies the space
	 * on the bottom side form the parent component. This should be a
	 * non-negative short.
	 */
	 ...
	 */
	public FlowLayoutLight() { this(CENTER); }

	/**
	 * Constructs a new <code>PRoFlowLayout</code> with the specified alignment
	 * and a default 10-unit horizontal and vertical gap.
	 * <p>
	 * The value of the alignment argument must be one of <code>PRoFlowLayout.LEFT</code>,
	 * <code>PRoFlowLayout.RIGHT</code>, <code>PRoFlowLayout.CENTER</code>,
	 * <code>PRoFlowLayout.LEADING</code>, or <code>PRoFlowLayout.TRAILING</code>.
	 * <p>
	 * There is no empty border around all components.
	 * 
	 * @param align the alignment value.
	 */
	public FlowLayoutLight(byte align) { this(align, 0, 0, 0, 0); }
	
	/**
	 * Creates a new <code>PRoFlowLayout</code> with the indicated alignment
	 ...
	 */
	public FlowLayoutLight(byte align, int hgap, int vgap) {
	...
	/**
	 * Creates a new <code>PRoFlowLayout</code> with the indicated alignment and the
	...
	private final void readObject(final ObjectInputStream stream) throws IOException,
		...
		if (serialVersionOnStream < 1) { this.setAlignment(this.align); }
	...
	public final void setAlignment(final byte align) {
		...
		switch (align) {
			...
			case LEADING:  { this.align = LEFT; break; }
			case TRAILING: { this.align = RIGHT; break; }
			default: { this.align = align; break; }
		}
	}
